...
class Notification(BaseDBModel):
    ...
    status: Mapped[NotificationStatus] = mapped_column(Enum(NotificationStatus, values_callable=lambda x: [e.value for e in x]), default=NotificationStatus.PENDING, server_default=text("'pending'"))
